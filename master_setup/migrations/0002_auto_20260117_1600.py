...
def load_countries(apps, schema_editor):
    Country = apps.get_model('master_setup', 'Country')
    ...
    countries_data = [
        ...
        ("Comoros", "KM", "COM", "269"),
        ("Congo", "CG", "COG", "242"),
        ("Congo (Democratic Republic)", "CD", "COD", "243"),
    ...
    for name, code, code_alpha3, phone_code in countries_data:
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_alpha3', models.CharField(help_text='ISO 3166-1 alpha-3 code', max_length=3, unique=True)),
                ('phone_code', models.CharField(blank=True, help_text='International dialing code (e.g., "1", "44")', max_length=10)),
            ],
            options={
        ...
        migrations.RunPython(load_countries, reverse_func),
    ]