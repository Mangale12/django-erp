...
class RoomAmnity(models.Model):
    name = models.CharField(max_length=100, unique=True, null=True, blank=True, help_text='Name of the room category (max 100 characters)')
